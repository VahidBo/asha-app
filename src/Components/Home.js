...
import { Card, Avatar, SocialIcon, Icon, Tooltip } from "react-native-elements";
        ...
        <Card containerStyle={{}}>
          ...
          <View style={{ marginTop: 12 }}>
            <Text numberOfLines={2}>
              This is a up to 50 characters caption and up to 3 hashtags.
            </Text>
          </View>
          <View style={{ marginTop: 12 }}>
            <Image
          ...
          <View style={{ flexDirection: "row" }}>
            <View style={{ flex: 1, flexDirection: "row" }}>
              <Tooltip
                ...
                popover={
                  <Text style={{ color: "white" }}>Twitter points: 24</Text>
                }
              >
              ...
              <Tooltip
                ...
                popover={
                  <Text style={{ color: "white" }}>Instagram points: 31</Text>
                }
              >
                <SocialIcon light raised={false} type="instagram" />
              </Tooltip>
              <Image
            ...
            <View style={{ flex: 0, flexDirection: "row" }}>
              <Icon name="note-add" type="material" color="#517fa4" />
            </View>
          </View>
        </Card>
        <Icon
